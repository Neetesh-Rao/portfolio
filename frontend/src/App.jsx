  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="flex justify-between items-center h-20">
      ...
      <div className="hidden md:flex items-center space-x-4">
        ...
        <button
          onClick={toggleTheme}
          className="p-3 rounded-full bg-gray-700/50 dark:bg-gray-200/50 text-white dark:text-gray-900 hover:scale-105 transition"
        >
          {theme === 'dark' ? '🌞' : '🌙'}
        </button>
      </div>
  ...
  {isMenuOpen && (
    <div className="md:hidden bg-gray-900/95 dark:bg-gray-100/95 backdrop-blur-lg border-t border-gray-800 dark:border-gray-300">
      ...
      <div className="px-6 py-3">
        <button
          onClick={toggleTheme}
          className="w-full p-3 rounded-full bg-gray-700/50 dark:bg-gray-200/50 text-white dark:text-gray-900 hover:scale-105 transition"
        >
